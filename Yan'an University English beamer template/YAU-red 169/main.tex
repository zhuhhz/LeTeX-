...
\begin{document}
	\begin{frame}
		...
		\begin{tikzpicture}[remember picture, overlay]
            \node[opacity=0.1] at ([shift={(0cm,-6.7cm)}]current page.north) {\includegraphics[width=14cm]{picture one.png}};
        \end{tikzpicture}
		\titlepage
	\end{frame}
	...
	\addtobeamertemplate{frametitle}{}{%
        \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=north east,yshift=2pt] at (current page.north east) {\includegraphics[height=0.9cm]{picture two.png}};
        \end{tikzpicture}}
