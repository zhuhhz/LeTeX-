...
\setbeamercolor{author in head/foot}{fg=white, bg=yaublue}  % 页脚作者颜色
\setbeamercolor{title in head/foot}{fg=yaublue, bg=gray!180!black}  % 页脚标题颜色
\setbeamercolor{date in head/foot}{fg=yaublue, bg=gray!170!black}  % 页脚日期颜色
\title{我的演示文稿}
\author{作者姓名}
...
\definecolor{uilink} {HTML}{00769E}%定义颜色
...
\setbeamercolor*{item projected}{fg=white, bg=yaublue!80!white}%颜色设置
\begin{document}
\begin{frame}
% 在右下角添加logo
...
\institute[123]{\small {\inst{1}School of Mathematics and Computer Science\and
 \inst{2} Affiliation of the 2nd author}}
		...
		\begin{tikzpicture}[remember picture, overlay]
            \node[opacity=0.1] at ([shift={(0cm,-7.9cm)}]current page.north) {\includegraphics[width=10cm]{图一.png}};
        \end{tikzpicture}
		\titlepage
	\end{frame}
	...
	\addtobeamertemplate{frametitle}{}{%
        \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=north east,yshift=2pt] at (current page.north east) {\includegraphics[height=0.8cm]{图二.png}};
        \end{tikzpicture}}
	
	\section{简介}
	\begin{frame}{简介}
			\begin{tikzpicture}[remember picture, overlay]
            \node[opacity=0.05] at ([shift={(4cm,-6.8cm)}]current page.north) {\includegraphics[width=3.5cm]{图三.png}};
        \end{tikzpicture}
	    使用了Madrid主题。
	\end{frame}
